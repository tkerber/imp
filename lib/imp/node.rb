...
module Imp
  ...
  # A node in a directory based tree with a filesystem-esque method of
  # referencing.
  class Node
    ...
    # Recursively removes any sub node leaves with a nil value.
    def prune
    ...
    # Prints the skeleton of the tree from this node.
    # 
    # Node labels are NOT printed.
    # 
